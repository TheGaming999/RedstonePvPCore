...
public class NoteBlockPlayerMain {
	...
	public void doSync(Runnable runnable) {
		Bukkit.getServer().getScheduler().runTask(RedstonePvPCore.getInstance(), runnable);
	}

	public void doAsync(Runnable runnable) {
		Bukkit.getServer().getScheduler().runTaskAsynchronously(RedstonePvPCore.getInstance(), runnable);
	}
